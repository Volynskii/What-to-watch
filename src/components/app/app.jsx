...
const WelcomeScreen = (props) => {
   const {genre,onMovieMouseEnter} = props;
  return <Fragment>
  ...
  d="M27 23.8571V16H23.8571V23.8571H16V27H23.8571H27L27 23.8571Z" fill="#FFF9D9" fill-opacity="0.7"/>
    <path fill-rule="evenodd" clip-rule="evenodd"
        ...
        return (
          <article className="small-movie-card catalog__movies-card"
            ...
            <div className="small-movie-card__image">
              <img src={card.src}
                   alt={card.alt} width="280" height="175"/>
            </div>
            <h3 className="small-movie-card__title">
              <a className="small-movie-card__link" href="movie-page.html">{card.name}</a>
            </h3>
          </article>
          )
      })}
...
class App extends React.PureComponent {
  constructor(props) {
    ...
    this.state = {
      gameGenre: 231312,
      movieCards: smallCards
    };
  }
    render() {
      return <WelcomeScreen
        genre={this.state.gameGenre}
        smallCardsData={this.state.movieCards}
        onMovieMouseEnter={() => console.log('Hello')}
      />;
    }
}
...
// const App = (props) => {
//  const {gameGenre,smallCards} = props
//
// return <WelcomeScreen
// genre={gameGenre}
// smallCardsData={smallCards}
// />
// }
//
export default App;
